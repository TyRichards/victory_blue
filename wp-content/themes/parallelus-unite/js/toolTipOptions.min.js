/* From:  jquery.cluetip.min.js */

/*
 * jQuery clueTip plugin
 * Version 1.0.6  (January 13, 2010) @requires jQuery v1.3+
...
/* From:  toolTipOptions.js */

jQuery(document).ready(function($){$.fn.cluetip.defaults.cluetipClass="skinned";$.fn.cluetip.defaults.cluezIndex=1234;$.fn.cluetip.defaults.dropShadow=false;$.fn.cluetip.defaults.topOffset=35;$.fn.cluetip.defaults.clickThrough=true;$.fn.cluetip.defaults.fx={open:"fadeIn",openSpeed:"100"};$.fn.cluetip.defaults.hoverIntent={sensitivity:3,interval:100,timeout:80};$.fn.cluetip.defaults.onShow=function(ct,c){if(jQuery("#cluetip-inner").html()==""){(jQuery.browser.msie)?jQuery("#cluetip").addClass("ieFix"):jQuery("#cluetip").addClass("mozFix")}else{(jQuery.browser.msie)?jQuery("#cluetip").removeClass("ieFix"):jQuery("#cluetip").removeClass("mozFix")}}});