...
Please rate this plugin and/or make a [donation](http://goo.gl/JSTOr "PayPal donation") if you find it useful, thank you.
...
You can make a Pay Pal donation by clicking [here](http://goo.gl/JSTOr "PayPal donation"), or click on "Donate to this plugin" in the right hand side box where it says FYI, your donation will be very gratefully received thank you!
...
These are for reference only, please do not use these as these are unlikely to be included in future versions and will therefore break your site upon upgrading the plugin.
...
= 1.4.8 =
* Added custom post types, if this was something you have been waiting for, or have requested then please consider making a [donation](http://goo.gl/JSTOr "PayPal donation") thank you!
...
= 1.5.3 =
Please change your code in the page you have your sitemap on to `[wp-realtime-sitemap show="all"]`, and re-save the settings for the plugin.
